  ...
  return (
    <section className="bg-white py-16 sm:py-20 border-b-[2px] border-[#1e2023]">
      ...
      <header className="mx-auto max-w-4xl px-6 text-center">
        <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl tracking-wide text-ink">
          LITTLE LUXURY. BIG CONNECTION.
        </h2>
        <p className="mt-3 text-sm text-charcoal/70">Make the first move this season.</p>
      </header>
