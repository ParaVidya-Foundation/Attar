    ...
    <main className="w-full bg-white">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-6 text-sm sm:text-base leading-7 text-gray-600 text-center">
          Our agarbatti is handcrafted for devotees who want clean, honest smoke for pooja, meditation, and
          daily arati. Unlike mass-market sticks that rely on synthetic binders and harsh accelerants, these
          agarbatti blends foreground natural resins, herbs, and traditional masala methods—so the room fills
          with a soft, true scent rather than chemical sharpness. Whether you use agarbatti at home or in a
          small mandir, each stick is made to honour ritual without compromising air quality or peace of mind.
        </p>
      </section>
        ...
        <div className="mt-8 space-y-3">
          <details className="group border border-neutral-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm text-neutral-600 leading-relaxed">
              Our agarbatti is bamboo-less where noted in each product, formulated with natural resins and
              botanicals rather than cheap wood-pulp cores soaked in synthetic fragrance. We avoid the harsh
              chemicals common in discount incense so you get a cleaner burn and a more authentic aroma for
              pooja and quiet practice.
            </p>
          </details>
          <details className="group border border-neutral-200 bg-white p-5">
            <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-left text-sm font-medium text-neutral-800">
            ...
            <p className="mt-3 text-sm text-neutral-600 leading-relaxed">
              Yes—when used with normal ventilation, our natural, non-toxic agarbatti is suitable for everyday
              arati and meditation. The sticks are crafted to produce comparatively low smoke and a steady,
              pleasant scent so you can light them regularly without overpowering your space.
            </p>
          </details>
          <details className="group border border-neutral-200 bg-white p-5">
            <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-left text-sm font-medium text-neutral-800">
            ...
            <p className="mt-3 text-sm text-neutral-600 leading-relaxed">
              Most of our agarbatti sticks burn for roughly 30–40 minutes under typical indoor conditions,
              giving you a full session for mantra, dhyana, or extended pooja without constant relighting.
            </p>
          </details>
          <details className="group border border-neutral-200 bg-white p-5">
            <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-left text-sm font-medium text-neutral-800">
            ...
            <p className="mt-3 text-sm text-neutral-600 leading-relaxed">
              Yes. Temples, ashrams, and community organisers can request larger quantities and custom needs
              through our bulk enquiry page—we will follow up with pricing and lead times.
            </p>
          </details>
        </div>
      </section>
      ...
      {/* Internal Links */}
      <nav
        className="mx-auto max-w-3xl px-6 pb-16 flex flex-wrap justify-center gap-3"
