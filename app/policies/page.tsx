...
export default function PoliciesPage() {
  return (
    <Container className="py-12 sm:py-16">
      ...
      <h1 className="mt-4 font-serif text-4xl tracking-tight text-ink sm:text-5xl">Policies</h1>
      <div className="mt-6 grid gap-4 text-sm leading-7 text-charcoal/85 sm:text-base">
        <section aria-labelledby="shipping">
          <h2 id="shipping" className="font-serif text-2xl text-ink">
            Shipping
          </h2>
          <p>
        ...
        <section aria-labelledby="returns">
          <h2 id="returns" className="font-serif text-2xl text-ink">
            Returns
          </h2>
          <p>In production, define return eligibility for opened oils and hygiene-sensitive goods.</p>
        </section>
        <section aria-labelledby="privacy">
          <h2 id="privacy" className="font-serif text-2xl text-ink">
            Privacy
          </h2>
          <p>
